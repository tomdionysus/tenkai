...
class Mob {
	constructor(options = {}) {
		...
		// The current X/Y from the origin of the container (the TiledScene, or the parent Mob)
		this.x = options.x || 0
		this.y = options.y || 0

		// The Z index, in the stack of the container (the TiledScene, or the parent Mob)
		this.z = options.z || 0

		// The mob hotspot offset X/Y - this is the offset to the point used to compute the Mob's 'feet'
		...
		// The Parent container (the TiledScene, or the parent Mob)
