...
class Scene {
	...
	* @property {integer} x The Scene x-coordinate in pixels relative to its parent (optional, default 0)
	* @property {integer} y The Scene y-coordinate in pixels relative to its parent (optional, default 0)
	* @property {integer} y The Scene z-coordinate relative to its parent (optional, default 0)
