...
class HasEventsMixin extends Mixin {
	...
	/**
	 * Trigger the given event with the specified arguments. Handlers are queued for execution using [setTimeout()]{@link https://developer.mozilla.org/en-US/docs/Web/API/Window/setTimeout}.
	 * @param {String} event The name of the event
