 ...
 */
class GameEngine extends Evented {
	/**
...
<script type="text/javascript">
	...
	*/
	constructor(options = {}) {
		...
		// A GameEngine has a collection of Entities
	...
	*/
	...
	_bindMouseWheel() {
		...
		if(this.onMouseDown) ael('mousedown', (e) => this.onMouseDown(e), false)
		if(this.onMouseUp) ael('mouseup', (e) => this.onMouseUp(e), false)
	}
	...
	*/
	...
	_tick() {
		...
		// HUD
		if(this.showHUD && this.clear) { this._draWHUD(context) }
	...
	*/
	recomputeFullScreen() {
		...
		this.width = this.element.width / this.scale
		this.height = this.element.height / this.scale
		if(this.onResize) setImmediate(()=>{ this.onResize() })
		this.redraw()
	}
